const projects = {
  ...
  1: {
    projecthead: "RSRP MapGen",
    projectphoto: "images/heatmapsgen.png",
    projecttext: "MapGen is a spatial RSRP map generator I built to simulate and visualize 5G cellular coverage with high accuracy. It transforms raw environmental data into precise signal propagation maps. The cover image is a conceptual visualization. The actual software is a sophisticated pipeline that integrates OpenStreetMap clutter data, performs deterministic ray-casting for LOS/NLOS conditions, and applies 3GPP TR 38.901 standard path-loss models. The tool is currently in a closed development phase, and the core architecture is not publicly available. It represents a significant step in my work to bridge theoretical radio propagation models with practical, deployment-ready software."
  },
  2: {
